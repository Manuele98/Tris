...
public class Server implements ActionListener {
	...
	String messaggio1 = "", messaggio2 = "", pos1 = "", pos2 = "", pos3 = "", pos4 = "", pos5 = "", pos6 = "",
			pos7 = "", pos8 = "", pos9 = "", vittorioso = "";
	...
	public void richiesta_socket() throws IOException {
		try {
			...
			f3.setMod("-> Socket1 connesso");
			socket2 = serverSocket.accept();
			f3.setMod("-> Socket2 connesso");
			...
			isr1 = new InputStreamReader(socket1.getInputStream());
			in1 = new BufferedReader(isr1);
			out1 = new PrintWriter(socket1.getOutputStream(), true);
			isr2 = new InputStreamReader(socket2.getInputStream());
